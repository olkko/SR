...
HD_PWD='C:/Users/USER/Desktop/SR/lab1/lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and_cascade.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and_cascade.tcl
