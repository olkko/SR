...
HD_PWD='C:/Users/USER/Desktop/SR/lab3_1/lab3_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log state_mashine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source state_mashine.tcl
