...
HD_PWD='C:/Users/USER/Desktop/SR/lab3_1/lab3_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log state_mashine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source state_mashine.tcl -notrace
