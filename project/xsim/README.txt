...
#
# Generated by export_simulation on Thu May 23 13:36:58 +0300 2024
#
################################################################################
...
'-reset_run' switch to the './tb_hdmi.sh' script.

./tb_hdmi.sh -reset_run
...
./tb_hdmi.sh -noclean_files

For more information on the script, please type './tb_hdmi.sh -help'.
