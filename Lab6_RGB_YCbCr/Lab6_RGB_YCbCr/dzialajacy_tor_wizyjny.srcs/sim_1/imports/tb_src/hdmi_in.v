...
begin
  ...
  begin  
    ...
    rgbfile = $fopen("C:/Users/USER/Desktop/SR/project_copy/hdmi_vga_zybo_tor_dziala/hdmi_vga_zybo/hand_photo.ppm","rb");
    if (rgbfile) $display("File was opened successfully : $0d", rgbfile);
    else         $display("File was NOT opened successfully : %0d", rgbfile);
    // read header file
    for(i=0;i<13;i=i+1)
    begin
      v=$fgetc(rgbfile); 
