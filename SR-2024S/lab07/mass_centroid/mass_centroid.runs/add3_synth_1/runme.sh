...
HD_PWD='C:/Users/janro/Pulpit/AGH_FILES/SR-2024S/lab07/mass_centroid/mass_centroid.runs/add3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add3.tcl
