...
HD_PWD='C:/Users/janro/Pulpit/AGH_FILES/SR-2024S/lab02/drzewo/drzewo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tree.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tree.tcl
