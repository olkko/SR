...
HD_PWD='C:/Users/janro/Pulpit/AGH_FILES/SR-2024S/lab07/mass_centroid/mass_centroid.runs/sub_cordinates_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_cordinates.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_cordinates.tcl
