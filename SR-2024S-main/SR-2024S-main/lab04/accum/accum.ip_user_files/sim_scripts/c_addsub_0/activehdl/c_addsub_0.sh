...
#
# Generated by Vivado on Sun Mar 24 20:56:30 +0100 2024
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/janro/Pulpit/AGH_FILES/SR-2024S/lab04/accum/accum.cache/compile_simlib/activehdl"
  fi
